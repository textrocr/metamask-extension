...
export const ONE_SWAPS_TOKEN_OBJECT = {
  symbol: ONE_SYMBOL,
  name: 'Matic',
  address: DEFAULT_TOKEN_ADDRESS,
  decimals: 18,
  iconUrl: ONE_TOKEN_IMAGE_URL,
};
...
const ONE_CONTRACT_ADDRESS = '0xD071ad893213E62fF3D620eF1B62a1E94aD11358';
...
export const WONE_CONTRACT_ADDRESS =
...
const ONE_DEFAULT_BLOCK_EXPLORER_URL = 'https://explorer.harmony.one/';
...
export const SWAPS_CHAINID_CONTRACT_ADDRESS_MAP = {
  ...
  [ONE_CHAIN_ID]: ONE_CONTRACT_ADDRESS,
...
export const SWAPS_WRAPPED_TOKENS_ADDRESSES = {
  ...
  [ONE_CHAIN_ID]: WONE_CONTRACT_ADDRESS,
};
...
export const ALLOWED_CONTRACT_ADDRESSES = {
  ...
  [ONE_CHAIN_ID]: [
    SWAPS_CHAINID_CONTRACT_ADDRESS_MAP[ONE_CHAIN_ID],
    SWAPS_WRAPPED_TOKENS_ADDRESSES[ONE_CHAIN_ID],
  ] 
};
...
export const SWAPS_CHAINID_DEFAULT_TOKEN_MAP = {
  ...
  [ONE_CHAIN_ID]: ONE_SWAPS_TOKEN_OBJECT,
};
...
export const SWAPS_CHAINID_DEFAULT_BLOCK_EXPLORER_URL_MAP = {
  ...
  [ONE_CHAIN_ID]: ONE_DEFAULT_BLOCK_EXPLORER_URL,
};
